    ...
    try {
      ...
      if (error instanceof Deno.errors.NotFound) {
        ...
        const content = [
          ...
          "## PLATFORM ICON",
          "platform_icon: false",
          "platform_icon_twitch_path: ./assets/media/icon_twitch.png",
          "platform_icon_youtube_path: ./assets/media/icon_youtube.png",
          "",
          "## FONT",
          "# Set to true to use a custom font for text overlays",
          "custom_font: false",
          "# Path to custom font file (TTF or OTF)",
          "custom_font_path: ./assets/media/font.ttf",
          "",
          "## INTRO",
    ...
    try {
      ...
      if (error instanceof Deno.errors.NotFound) {
        ...
        const content = [
          ...
          "#",
          "# u = username",
          "# p = platform (twitch, youtube, medal.tv)",
          "#",
          "# The position of the link in the list is the order in which the clip will be downloaded and processed.",
          "#",
          ...
          "#",
          "# only Twitch, YouTube and Medal.tv clips are supported for now",
          "#",
          "###############\n\n",
        ]
